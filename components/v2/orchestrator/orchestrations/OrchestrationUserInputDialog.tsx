...
interface OrchestrationUserInputDialogProps {
  open: boolean
...
export function OrchestrationUserInputDialog({
  open,
  onOpenChange,
  pendingInputs,
  onSubmit,
  isLoading = false,
}: OrchestrationUserInputDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            The orchestration is paused and requires your input to continue. Please provide the

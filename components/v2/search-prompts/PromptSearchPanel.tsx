...
import { useSearchPrompts } from '@/lib/queries-v2'
import { PromptSearchResults } from './PromptSearchResults'
import { PromptViewDialog } from '@/components/v2/prompts/PromptViewDialog'
...
export function PromptSearchPanel() {
  ...
  const { data: results, isLoading, error } = useSearchPrompts(debouncedQuery, topK)
    ...
    <div className="space-y-6">
      ...
      {!debouncedQuery && (
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p>Enter a search query to find relevant prompts</p>
        </div>
      )}
